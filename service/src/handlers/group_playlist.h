...
class group_playlist {
 public:
  ...
  tgbot::ymsummorizer_callback_result::ptr on_group_playslit_list(
      const tgbot::user_interaction& ui);
  tgbot::ymsummorizer_callback_result::ptr on_group_playslit_view(
      const tgbot::user_interaction& ui);
  tgbot::ymsummorizer_callback_result::ptr on_group_playslit_add(const tgbot::user_interaction& ui);
  tgbot::ymsummorizer_callback_result::ptr on_group_playslit_remove(
      const tgbot::user_interaction& ui);
